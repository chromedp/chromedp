...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker(in *jlexer.Lexer, out *UpdateRegistrationParams) {
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker(out *jwriter.Writer, in UpdateRegistrationParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker1(in *jlexer.Lexer, out *UnregisterParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker1(out *jwriter.Writer, in UnregisterParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker2(in *jlexer.Lexer, out *StopWorkerParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker2(out *jwriter.Writer, in StopWorkerParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker3(in *jlexer.Lexer, out *StartWorkerParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker3(out *jwriter.Writer, in StartWorkerParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker4(in *jlexer.Lexer, out *SkipWaitingParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker4(out *jwriter.Writer, in SkipWaitingParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker5(in *jlexer.Lexer, out *SetForceUpdateOnPageLoadParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker5(out *jwriter.Writer, in SetForceUpdateOnPageLoadParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker6(in *jlexer.Lexer, out *ServiceWorkerVersion) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "controlledClients":
			if in.IsNull() {
				...
				in.Delim('[')
				if !in.IsDelim(']') {
					out.ControlledClients = make([]target.TargetID, 0, 4)
				} else {
					out.ControlledClients = []target.TargetID{}
				}
				for !in.IsDelim(']') {
					var v1 target.TargetID
					v1 = target.TargetID(in.String())
		...
		case "targetId":
			out.TargetID = target.TargetID(in.String())
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker6(out *jwriter.Writer, in ServiceWorkerVersion) {
	out.RawByte('{')
	first := true
	_ = first
	if in.VersionID != "" {
...
// MarshalJSON supports json.Marshaler interface
func (v ServiceWorkerVersion) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ServiceWorkerVersion) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker6(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ServiceWorkerVersion) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ServiceWorkerVersion) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker6(l, v)
}
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker7(in *jlexer.Lexer, out *ServiceWorkerRegistration) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker7(out *jwriter.Writer, in ServiceWorkerRegistration) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RegistrationID != "" {
...
// MarshalJSON supports json.Marshaler interface
func (v ServiceWorkerRegistration) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ServiceWorkerRegistration) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker7(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ServiceWorkerRegistration) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ServiceWorkerRegistration) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker7(l, v)
}
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpServiceworker8(in *jlexer.Lexer, out *ServiceWorkerErrorMessage) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker8(out *jwriter.Writer, in ServiceWorkerErrorMessage) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ErrorMessage != "" {
...
// MarshalJSON supports json.Marshaler interface
func (v ServiceWorkerErrorMessage) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v ServiceWorkerErrorMessage) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonC5a4559bEncodeGithubComKnqChromedpCdpServiceworker8(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *ServiceWorkerErrorMessage) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ServiceWorkerErrorMessage) UnmarshalEasyJSON(l *jlexer.Lexer) {
	...
	for !in.IsDelim('}') {
		...
		case "versions":
			if in.IsNull() {
				...
				in.Delim('[')
				if !in.IsDelim(']') {
					out.Versions = make([]*ServiceWorkerVersion, 0, 8)
				} else {
					out.Versions = []*ServiceWorkerVersion{}
				}
				for !in.IsDelim(']') {
					var v4 *ServiceWorkerVersion
					if in.IsNull() {
						in.Skip()
						v4 = nil
					} else {
						if v4 == nil {
							v4 = new(ServiceWorkerVersion)
						}
	...
	for !in.IsDelim('}') {
		...
		case "registrations":
			if in.IsNull() {
				...
				in.Delim('[')
				if !in.IsDelim(']') {
					out.Registrations = make([]*ServiceWorkerRegistration, 0, 8)
				} else {
					out.Registrations = []*ServiceWorkerRegistration{}
				}
				for !in.IsDelim(']') {
					var v7 *ServiceWorkerRegistration
					if in.IsNull() {
						in.Skip()
						v7 = nil
					} else {
						if v7 == nil {
							v7 = new(ServiceWorkerRegistration)
						}
		...
		case "errorMessage":
			if in.IsNull() {
				...
				if out.ErrorMessage == nil {
					out.ErrorMessage = new(ServiceWorkerErrorMessage)
				}
