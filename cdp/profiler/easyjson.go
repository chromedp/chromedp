...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler(in *jlexer.Lexer, out *PositionTickInfo) {
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler(out *jwriter.Writer, in PositionTickInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Line != 0 {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler1(in *jlexer.Lexer, out *Profile) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "samples":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v2 int64
					v2 = int64(in.Int64())
					out.Samples = append(out.Samples, v2)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "timeDeltas":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v3 int64
					v3 = int64(in.Int64())
					out.TimeDeltas = append(out.TimeDeltas, v3)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler1(out *jwriter.Writer, in Profile) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Nodes) != 0 {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler2(in *jlexer.Lexer, out *ProfileNode) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "positionTicks":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v11 *PositionTickInfo
					if in.IsNull() {
						in.Skip()
						v11 = nil
					} else {
						if v11 == nil {
							v11 = new(PositionTickInfo)
						}
						(*v11).UnmarshalEasyJSON(in)
					}
					out.PositionTicks = append(out.PositionTicks, v11)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler2(out *jwriter.Writer, in ProfileNode) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != 0 {
	...
	if len(in.PositionTicks) != 0 {
		...
		if in.PositionTicks == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v14, v15 := range in.PositionTicks {
				if v14 > 0 {
					out.RawByte(',')
				}
				if v15 == nil {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler3(in *jlexer.Lexer, out *StopReturns) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler3(out *jwriter.Writer, in StopReturns) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Profile != nil {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler5(in *jlexer.Lexer, out *StartParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler5(out *jwriter.Writer, in StartParams) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler6(in *jlexer.Lexer, out *SetSamplingIntervalParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler6(out *jwriter.Writer, in SetSamplingIntervalParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler7(in *jlexer.Lexer, out *DisableParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler7(out *jwriter.Writer, in DisableParams) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler8(in *jlexer.Lexer, out *EnableParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler8(out *jwriter.Writer, in EnableParams) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler9(in *jlexer.Lexer, out *EventConsoleProfileFinished) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler9(out *jwriter.Writer, in EventConsoleProfileFinished) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpProfiler10(in *jlexer.Lexer, out *EventConsoleProfileStarted) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpProfiler10(out *jwriter.Writer, in EventConsoleProfileStarted) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
