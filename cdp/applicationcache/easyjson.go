...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache(in *jlexer.Lexer, out *FrameWithManifest) {
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache(out *jwriter.Writer, in FrameWithManifest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FrameID != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache1(in *jlexer.Lexer, out *ApplicationCache) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache1(out *jwriter.Writer, in ApplicationCache) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ManifestURL != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache2(in *jlexer.Lexer, out *Resource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache2(out *jwriter.Writer, in Resource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.URL != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache3(in *jlexer.Lexer, out *EventNetworkStateUpdated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache3(out *jwriter.Writer, in EventNetworkStateUpdated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IsNowOnline {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache4(in *jlexer.Lexer, out *EventApplicationCacheStatusUpdated) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache4(out *jwriter.Writer, in EventApplicationCacheStatusUpdated) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FrameID != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache7(in *jlexer.Lexer, out *GetManifestForFrameReturns) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache7(out *jwriter.Writer, in GetManifestForFrameReturns) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ManifestURL != "" {
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache8(in *jlexer.Lexer, out *GetManifestForFrameParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache8(out *jwriter.Writer, in GetManifestForFrameParams) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
	...
	for !in.IsDelim('}') {
		...
		case "frameIds":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 *FrameWithManifest
					if in.IsNull() {
						in.Skip()
						v4 = nil
					} else {
						if v4 == nil {
							v4 = new(FrameWithManifest)
						}
						(*v4).UnmarshalEasyJSON(in)
					}
					out.FrameIds = append(out.FrameIds, v4)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache10(out *jwriter.Writer, in GetFramesWithManifestsReturns) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjsonC5a4559bDecodeGithubComKnqChromedpCdpApplicationcache11(in *jlexer.Lexer, out *GetFramesWithManifestsParams) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC5a4559bEncodeGithubComKnqChromedpCdpApplicationcache11(out *jwriter.Writer, in GetFramesWithManifestsParams) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
